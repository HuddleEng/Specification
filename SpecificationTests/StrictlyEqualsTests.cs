...
{
    public class StrictlyEqualsTests
    {
        [Test]
        ...
        [Test]
        public void AndNodesWithFlippedChildrenAreNotEqual()
        {
            AssertNotEqual(new FailingSpecification<object>().And(new PassingSpecification<object>()), new PassingSpecification<object>().And(new FailingSpecification<object>()));
        }
        ...
        [Test]
        public void OrNodesWithFlippedChildrenAreNotEqual()
        {
            AssertNotEqual(new FailingSpecification<object>().Or(new PassingSpecification<object>()), new PassingSpecification<object>().Or(new FailingSpecification<object>()));
        }
